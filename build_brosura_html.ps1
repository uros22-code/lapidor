...
<head>
  ...
  <title>Ekskluzivna PrestiÄąÄľna BroÄąË‡ura LAPIDOR | Naravni Vietnamski Marmor</title>
...
<body class="b-page">
  ...
  <div class="top-bar">
    <div class="container top-bar-content">
      ...
      <div class="top-bar-right">
        <a href="https://lapidor.si/#vzorci" class="top-link"><i class="fa-solid fa-paper-plane text-gold"></i> <span data-i18n="top_inquiry">POÄąÂ LJI POVPRAÄąÂ EVANJE</span></a>
    ...
    <div class="container header-container">
      ...
      <nav class="main-nav" id="main-nav">
        <ul>
          ...
          <li><a href="https://lapidor.si/#nasazgodba" class="nav-link" data-i18n="nav_story">NAÄąÂ A ZGODBA</a></li>
          <li><a href="https://lapidor.si/#nasiizdelki" class="nav-link" data-i18n="nav_products">NAÄąÂ I IZDELKI</a></li>
          <li><a href="https://lapidor.si/#kontakt" class="nav-link" data-i18n="nav_contact">KONTAKT</a></li>
          <li><a href="brosura.html" class="nav-link active" data-i18n="nav_brochure">BROÄąÂ URA</a></li>
        </ul>
      </nav>
  ...
  <section class="b-cover">
    <div class="container">
      ...
      <div class="b-cover-subtitle" data-i18n="brochure_cover_sub">EKSKLUZIVNA PRESTIÄąËťNA BROÄąÂ URA</div>
      ...
      <div class="b-actions">
        ...
        <a href="https://lapidor.si/#vzorci" class="btn btn-gold" data-i18n="top_inquiry">
          <i class="fa-solid fa-paper-plane"></i> POÄąÂ LJI POVPRAÄąÂ EVANJE
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="b-section">
    <div class="container">
      <div style="text-align: center; margin-bottom: 28px;">
        <span class="section-tag" style="display: block; text-align: center; margin-bottom: 8px;" data-i18n="about_tag">NAÄąÂ A ZGODBA</span>
      ...
      <div class="b-card">
        ...
        <div class="b-stat-box">
          ...
          <div class="b-stat-card">
            ...
            <div class="b-stat-label" data-i18n="stat_3_label">PO VAÄąÂ I MERI</div>
        ...
        <div class="b-cat-card">
          ...
          <div class="b-cat-body">
            ...
            <p style="font-size: 0.9rem; margin-top: 8px;" data-i18n="b_app1_desc">
              PrestiÄąÄľne rezidence, privatne kopalnice, dnevni saloni ter unikatni masivni kosi opreme po meri zahtevnih naroĂ„Ĺ¤nikov.
            </p>
  ...
  <section class="b-section text-center" style="background: var(--bg-dark-accent); color: #ffffff;">
    <div class="container">
      <span class="section-tag" style="color: var(--gold-light);" data-i18n="b_cta_tag">VAÄąÂ  PROJEKT, NAÄąÂ A IZVEDBA</span>
      ...
      <div style="display: flex; justify-content: center; gap: 16px; flex-wrap: wrap;">
        <a href="https://lapidor.si/#vzorci" class="btn btn-gold btn-lg" target="_blank" data-i18n="top_inquiry">
          <i class="fa-solid fa-paper-plane"></i> POÄąÂ LJI POVPRAÄąÂ EVANJE (lapidor.si/#vzorci)
        </a>
  ...
  <div class="floating-contact-widget">
    ...
    <a href="https://lapidor.si/#vzorci" class="float-btn float-inquiry" title="PoÄąË‡lji povpraÄąË‡evanje" target="_blank">
      ...
      <span class="float-tooltip" data-i18n="float_inquiry">HITRO POVPRAÄąÂ EVANJE</span>
    </a>
  </div>
