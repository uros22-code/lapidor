...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Ekskluzivna Brošura LAPIDOR | Naravni Vietnamski Marmor</title>
  <meta name="description" content="Uradna prestižna brošura blagovne znamke LAPIDOR. Odkrijte naravni vietnamski marmor, ročno obdelavo, masivne kadi, umivalnike ter področja uporabe.">
  ...
  <meta property="og:url" content="https://lapidor.si/brosura.html">
  <meta property="og:title" content="Ekskluzivna Brošura LAPIDOR | Naravni Vietnamski Marmor">
  <meta property="og:description" content="Preglejte ekskluzivno brošuro LAPIDOR z unikatnimi klesarskimi izdelki iz naravnega vietnamskega marmorja.">
  <meta property="og:image" content="https://lapidor.si/assets/b_opt_hero.jpg">
  <meta property="og:site_name" content="LAPIDOR">
  <meta property="og:locale" content="sl_SI">

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Ekskluzivna Brošura LAPIDOR | Naravni Vietnamski Marmor">
  <meta name="twitter:description" content="Preglejte ekskluzivno brošuro LAPIDOR z unikatnimi klesarskimi izdelki iz naravnega vietnamskega marmorja.">
  <meta name="twitter:image" content="https://lapidor.si/assets/b_opt_hero.jpg">

  <!-- Schema.org JSON-LD Structured Data for Brochure Page -->
    ...
    "@graph": [
      {
        ...
        "@id": "https://lapidor.si/brosura.html#document",
        "name": "Ekskluzivna Brošura LAPIDOR - Naravni Vietnamski Marmor",
        "url": "https://lapidor.si/brosura.html",
        "fileFormat": "text/html",
        "publisher": {
          "@type": "Organization",
          "name": "LAPIDOR",
          "url": "https://lapidor.si/"
        }
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://lapidor.si/brosura.html#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
            "name": "Domov",
            "item": "https://lapidor.si/"
          },
          {
            "@type": "ListItem",
            "position": 2,
            "name": "Ekskluzivna Brošura",
            "item": "https://lapidor.si/brosura.html"
          }
        ]
      }
    ]
...
<body class="b-page">
 ...
 <section class="b-section">
  <div class="container">
   ...
   <div class="b-card">
    ...
    <div style="margin-top: 36px; margin-bottom: 36px; border-top: 1px solid rgba(184, 139, 42, 0.2); padding-top: 28px;" class="pdf-page-break">
   ...
   <div class="b-gallery-grid">
    ...
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_1.jpg" alt="Unikatni marmorni izdelek LAPIDOR - Shiva" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_2.jpg" alt="Unikatni marmorni izdelek LAPIDOR - Jesus" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_3.jpg" alt="Unikatni marmorni izdelek LAPIDOR - Mary 1" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_4.jpg" alt="Unikatni marmorni izdelek LAPIDOR - Mary 2" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_5.jpg" alt="Unikatni marmorni izdelek LAPIDOR - Jade buddha" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_6.jpg" alt="Unikatni marmorni izdelek LAPIDOR - Mother Teresa" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_7.jpg" alt="Unikatni marmorni izdelek LAPIDOR - girl" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_8.jpg" alt="Unikatni marmorni izdelek LAPIDOR - girl" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_9.jpg" alt="Unikatni marmorni izdelek LAPIDOR - girl" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_10.jpg" alt="Unikatni marmorni izdelek LAPIDOR - elephant" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_11.jpg" alt="Unikatni marmorni izdelek LAPIDOR - elephant" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_12.jpg" alt="Unikatni marmorni izdelek LAPIDOR - elephant" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item_13.jpg" alt="Unikatni marmorni izdelek LAPIDOR - Green phoenix" loading="lazy">
      </a>
     </div>
    </div>
    <div class="b-gallery-card">
     <div class="b-gallery-img-box">
      <a href="https://lapidor.si/#nasiizdelki" target="_blank">
       <img loading="lazy" decoding="async" src="assets/gal_item